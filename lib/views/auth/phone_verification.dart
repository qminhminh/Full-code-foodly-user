...
import 'package:foodly_user/controllers/phone_verification_controller.dart';

import 'package:foodly_user/services/verification.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => controller.isLoading == false
        ? PhoneVerification(
            ...
            enableLogo: false,
            themeColor: kPrimary,
            initialPageText: "Foodly Phone Verification",
